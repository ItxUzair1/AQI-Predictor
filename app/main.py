...
st.subheader("Historical Predictions (Past Days)")
st.markdown("Archive of past daily AQI predictions generated by the model.")
        ...
        for i, (col, day) in enumerate(zip(past_cols, past_data)):
            with col:
                ...
                <div class="prediction-card" style="border: 1px dashed rgba(255, 255, 255, 0.15); background: rgba(255, 255, 255, 0.02); padding: 25px 20px;">
                    <p style="color:#a0aec0; font-size:0.85rem; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom:4px; text-align:center;">{day['date']}</p>
                    <div class="aqi-value {day['css_class']}" style="font-size: 64px; margin: 10px 0; text-align:center; font-weight: 900;">{day['predicted_aqi']}</div>
